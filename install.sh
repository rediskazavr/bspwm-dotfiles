...
sudo pacman -Syu
sudo pacman -S xorg xorg-xinit bspwm sxhkd polybar alacritty feh dmenu git base-devel neovim fastfetch cava cmatrix firefox lf zsh ttf-font-awesome ttf-jetbrains-mono ttf-jetbrains-mono-nerd --noconfirm
